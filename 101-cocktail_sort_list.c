...
/**
 * swap_node - swaps the elements of the list
 * @ptr1: first pointer
 * @ptr2: second pointer
...
/**
 * high_sort - move the bigger numbers to the end
...
/**
 * low_sort - moves the smaller numbers to the start
...
void cocktail_sort_list(listint_t **list)
{
	...
	do {
		high_sort(&ptr, &limit1, list);
		low_sort(&ptr, &limit2, list);
	} while (limit1 != limit2);
}
